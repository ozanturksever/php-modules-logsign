...
mkdir -p ${package_directory}/usr/lib/php5/20090626
mkdir -p ${package_directory}/etc/php5/conf.d/
rsync -a --exclude=.git --exclude=debian/ --exclude=.idea --exclude=.DS_Store ${repository_directory}/modules/* ${package_directory}/usr/lib/php5/20090626/
rsync -a --exclude=.git --exclude=debian/ --exclude=.idea --exclude=.DS_Store ${repository_directory}/ini/* ${package_directory}/etc/php5/conf.d/
